...
ActiveRecord::Schema.define(version: 20160206192100) do
  ...
  add_index "musicians", ["instrument_type", "instrument_id"], name: "index_musicians_on_instrument_type_and_instrument_id", using: :btree
